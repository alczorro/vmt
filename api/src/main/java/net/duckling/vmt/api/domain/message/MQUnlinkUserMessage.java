 ...
 * @since 2013-8-2
 */
public class MQUnlinkUserMessage extends MQBaseMessage{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1586244007920355021L;

	/**
	 * @param operation
	 * @param scope
	 */
	public MQUnlinkUserMessage(List<VmtUser> users,VmtOrg org,VmtDepart dept,VmtGroup group) {
		super(OPERATION_DELETE, SCOPE_USER);
		this.users=users;
		this.org=org;
		this.dept=dept;
		this.group=group;
