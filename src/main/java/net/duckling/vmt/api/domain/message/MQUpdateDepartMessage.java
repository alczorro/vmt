 ...
 * @since 2013-8-2
 */
public class MQUpdateDepartMessage extends MQBaseMessage{
	/**
	 * 
	 */
	private static final long serialVersionUID = -5233049024098162532L;
	 ...
	 * @param scope
	 */
	public MQUpdateDepartMessage(VmtDepart dept) {
		super(OPERATION_UPDATE,SCOPE_DEPT);
		this.dept=dept;
	}
