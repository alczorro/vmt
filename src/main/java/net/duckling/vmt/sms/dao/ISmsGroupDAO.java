...
public interface ISmsGroupDAO {
	List<SmsGroup> findAll();

	int create(SmsGroup smsGroup);

	SmsGroup getGroupById(int gid);

	void update(SmsGroup gupdate);

	boolean isAccountUsed(String trim);

	void removeGropyById(int gid);

	void plusSmsUsedByID(int groupId,int count);
