...
public interface IVmtAppService {
	
	void addApp(VmtApp app);
	
	void addAppBatch(List<VmtApp> app);
	...
	List<VmtApp> searchAppByTeamDnsNoDistinct(List<String> orgDNS);

	List<VmtApp> distinctApp(List<VmtApp> apps);
}
