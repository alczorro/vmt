...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		// 图片上传配置区
		,
		contextPath : window.vmt.context,
		imageUrl :  window.vmt.context+ "/ueditor/imgUp" // 图片上传提交地址
		,
		...
		// 附件上传配置区
		,
		fileUrl : vmt.context + "/ueditor/fileUp" // 附件上传提交地址
		,
		...
		// 图片在线管理配置区
		,
		imageManagerUrl : vmt.context + "/ueditor/imgManage" // 图片在线管理的处理地址
		,
		...
		,
		toolbars : [ ['fontfamily', 'fontsize', '|', 'bold', 'italic', 'underline', '|',   
